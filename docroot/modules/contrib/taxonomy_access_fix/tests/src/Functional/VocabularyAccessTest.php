...
class VocabularyAccessTest extends TaxonomyTestBase {
  ...
  public function testTaxonomyVocabularyOperations() {
    ...
    foreach ($this->vocabularies as $delta => $vocabulary) {
      ...
      $this->assertVocabularyAccess($vocabulary, 'reset', TRUE);
    ...
    foreach ($this->vocabularies as $delta => $vocabulary) {
      ...
      $this->assertVocabularyAccess($vocabulary, 'reset', FALSE, "The 'reset {$vocabulary->id()}' OR 'reset any vocabulary' OR 'administer taxonomy' permission is required.");
